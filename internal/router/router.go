...
func InitRoute() *gin.Engine {
	...
	router.GET("/blog/of/follow")                                                  // TODO
	router.POST("/blog")                                                           // TODO 点赞
	...
	router.GET("/follow/common/:id", handlers.UserHandler.CommonFollow) // 共同关注
	router.Use(middleware.AuthRequired())
	{
		router.PUT("/blog/like/:blogId", handlers.BlogHandler.LikeBlogByUserId) // 点赞
		router.POST("/upload/blog", handlers.BlogHandler.UploadBlogImg)         // TODO 照片上传
		router.POST("/")
